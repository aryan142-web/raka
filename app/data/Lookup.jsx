...
export default {
  ...
  SIGNIN_HEADING: 'Continue With pi',
  SIGNIN_SUBHEADING: 'To use pi you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using pi, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use pi a few times per week.',
      price:19.99
    },
    {
      name:'Pro',
